...
@WebServlet("/GetProjectActivities")
public class GetProjectActivities extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String, Object>> activities = activityDAO.getProjectActivities(projectId, limit);
